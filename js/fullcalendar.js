...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        if (isDayNumberVisible) {
            html += view.buildGotoAnchorHtml(date, { 'class': 'fc-day-number new' }, date.format('D') // inner HTML
            );
        }
        html += '</td>';
        return html;
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.render = function () {
        ...
        if (sections) {
            ...
            el.append(this.renderSection('right'))
...
//I commentted out the daily view and the weekly view so I could insert my own- Elizabeth elizabethrodricks
